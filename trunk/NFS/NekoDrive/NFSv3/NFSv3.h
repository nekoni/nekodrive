...
public:
	...
	int Open(char* pName);
	void CloseFile();
	int Read(char* pName, unsigned __int64 Offset, u_long Count, char* pBuffer, u_int* pSize);
	int Read(unsigned __int64 Offset, u_long Count, char* pBuffer, u_int* pSize);
	int Write(char* pName, unsigned __int64 Offset, u_long Count, char* pBuffer, u_int* pSize);
	...
	int SetFileSize(char* pName, char* pDirectory, __int64 Size);
};
