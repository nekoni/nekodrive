	...
	CLIENT *clnt;
{
	...
	bzero((char *)&res, sizeof(res));
	if (clnt_call(clnt, NFSPROC_GETATTR, xdr_nfshandle, argp, xdr_attrstat, &res, TIMEOUT) != RPC_SUCCESS) {
		return (NULL);
	}
	return (&res);
}
	...
	CLIENT *clnt;
{
	...
	bzero((char *)&res, sizeof(res));
	if (clnt_call(clnt, NFSPROC_READLINK, xdr_nfshandle, argp, xdr_readlinkres, &res, TIMEOUT) != RPC_SUCCESS) {
		return (NULL);
	}
	return (&res);
}
	...
	CLIENT *clnt;
{
	...
	bzero((char *)&res, sizeof(res));
	if (clnt_call(clnt, NFSPROC_STATFS, xdr_nfshandle, argp, xdr_statfsres, &res, TIMEOUT) != RPC_SUCCESS) {
		return (NULL);
	}
	return (&res);
}
